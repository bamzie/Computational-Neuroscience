...
EXC_VISUAL = EXC[:Ne//2]
print('exv visual:: ', len(EXC_VISUAL))
INH_VISUAL = INH[:Ni//2]
print('inh visual:: ', len(INH_VISUAL))

# Units receiving auditory input
EXC_AUDITORY = EXC[Ne//2:Ne]
print("exc aud:: ", len(EXC_AUDITORY))
INH_AUDITORY = INH[Ni//2:Ni]
print("inh aud:: ", len(INH_AUDITORY));
#-----------------------------------------------------------------------------------------
# Input connectivity
#-----------------------------------------------------------------------------------------
